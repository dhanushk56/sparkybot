...
function RoleMultiSelect({ value, onChange, label, placeholder = "Select roles...", roleOptions }) {
  ...
  // Get available roles (not selected)
  const availableRoles = (roleOptions || []).filter(r => !ids.includes(r.id));
  
  // Filter available roles by search term
        ...
        >
          ...
          <div style={{ padding: "0.5rem", borderBottom: "1px solid #2b2d31", position: "sticky", top: 0, backgroundColor: "#1e1f22", zIndex: 1 }}>
            <input
              ...
              onBlur={(e) => e.currentTarget.style.borderColor = "#3b3d41"}
            />
          </div>
...
function NavItem({ icon, label, section, activeSection, onClick }) {
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: "0.9rem", fontWeight: isActive ? "600" : "400" }}>{label}</span>
    </div>
  );
}
          ...
          <>
            ...
            <div className="field-group">
              ...
              <RoleMultiSelect 
                ...
                onChange={set("autoroles")} 
                roleOptions={roleOptions}
                placeholder="Select auto-roles..."
              />
            </div>
            <div className="field-group">
          ...
          <>
            ...
            <div className="field-group">
              ...
              <RoleMultiSelect 
                ...
                onChange={setNested("automod", "ignored_roles")} 
                roleOptions={roleOptions}
        ...
        return (
          <>
            ...
            <div className="field-group">
              ...
              <RoleMultiSelect 
                value={form.ticket_staff_roles || []} 
                onChange={set("ticket_staff_roles")} 
                roleOptions={roleOptions}
        ...
        return (
          <>
            ...
            <div className="field-group">
              ...
              <RoleMultiSelect 
                value={form.xp_role_blacklist || []} 
                onChange={set("xp_role_blacklist")} 
                roleOptions={roleOptions}
                placeholder="Select XP blacklisted roles..."
              />
            </div>
            <div className="field-group">
        ...
        return (
          <>
            ...
            <div className="field-group">
              ...
              <RoleMultiSelect 
                value={antinuke.global_whitelist_roles || []} 
                onChange={setNested("antinuke", "global_whitelist_roles")} 
                roleOptions={roleOptions}
        ...
        return (
          <>
            ...
            <div className="field-group">
              <label>Ignored Roles</label>
              <RoleMultiSelect 
                value={autotranslate.ignored_roles || []} 
                onChange={setNested("autotranslate", "ignored_roles")} 
                roleOptions={roleOptions}
                placeholder="Select ignored roles..."
              />
            </div>
    ...
    <div style={{ display: "flex", gap: "2rem", height: "100%", minHeight: "600px" }}>
      ...
      >
        <div style={{ marginBottom: "1.5rem", paddingLeft: "0.5rem" }}>
          <h3 style={{ color: "#e8e0d8", fontSize: "0.9rem", opacity: 0.6, fontWeight: "400", margin: 0 }}>
            Server Settings
          </h3>
        </div>
      ...
      >
        ...
        {/* Save Bar - Sticky at bottom of content area */}
        <div
          style={{
            position: "sticky",
            bottom: 0,
